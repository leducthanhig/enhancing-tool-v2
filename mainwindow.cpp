...
void MainWindow::on_comboBox_Res_currentIndexChanged(int index) {
    ...
    case 0:
        ...
        else ui->lineEdit_Output->setText(fo.absolutePath() + "/" + fi.baseName() + "_" + ui->lineEdit_Res->text() + 'x' + ui->lineEdit_Res_2->text() + '.' + fo.suffix());
        break;
    case 1:
        if (type == "dir") ui->lineEdit_Output->setText(ui->lineEdit_Output->text().removeLast() + '1');
        else ui->lineEdit_Output->setText(fo.absolutePath() + "/" + fi.baseName() + "_" + res[0] + 'x' + res[1] + '.' + fo.suffix());
        break;
    case 2:
        if (type == "dir") ui->lineEdit_Output->setText(ui->lineEdit_Output->text().removeLast() + '2');
        else ui->lineEdit_Output->setText(fo.absolutePath() + "/" + fi.baseName() + "_" + QString::number(res[0].QString::toInt()*2, 10) + 'x' + QString::number(res[1].QString::toInt()*2, 10) + '.' + fo.suffix());
        break;
    case 3:
        if (type == "dir") ui->lineEdit_Output->setText(ui->lineEdit_Output->text().removeLast() + '3');
        else ui->lineEdit_Output->setText(fo.absolutePath() + "/" + fi.baseName() + "_" + QString::number(res[0].QString::toInt()*3, 10) + 'x' + QString::number(res[1].QString::toInt()*3, 10) + '.' + fo.suffix());
        break;
    case 4:
        if (type == "dir") ui->lineEdit_Output->setText(ui->lineEdit_Output->text().removeLast() + '4');
        else ui->lineEdit_Output->setText(fo.absolutePath() + "/" + fi.baseName() + "_" + QString::number(res[0].QString::toInt()*4, 10) + 'x' + QString::number(res[1].QString::toInt()*4, 10) + '.' + fo.suffix());
        break;
    default:
        if (type == "dir") ui->lineEdit_Output->setText(ui->lineEdit_Output->text().removeLast() + '8');
        else ui->lineEdit_Output->setText(fo.absolutePath() + "/" + fi.baseName() + "_" + QString::number(res[0].QString::toInt()*8, 10) + 'x' + QString::number(res[1].QString::toInt()*8, 10) + '.' + fo.suffix());
    }
}
...
void MainWindow::on_lineEdit_Res_editingFinished() {
    if (type != "dir") {    //When "type == dir" does not support custom resolution
        ...
        ui->lineEdit_Output->setText(fo.absolutePath() + "/" + fi.baseName() + "_" + ui->lineEdit_Res->text() + 'x' + ui->lineEdit_Res_2->text() + '.' + fo.suffix());
        ui->comboBox_Res->setCurrentIndex(0);
    }
}
...
void MainWindow::on_comboBox_Fps_currentIndexChanged(int index) {
    switch (index) {
    case 0:
        if (ui->lineEdit_Fps->text().toFloat() > fps.toFloat()) ui->lineEdit_Output->setText(fo.absolutePath() + "/" + fi.baseName() + "_" + ui->lineEdit_Fps->text() + "FPS." + fo.suffix());
        break;
    case 1:
        ui->lineEdit_Output->setText(fo.absolutePath() + "/" + fi.baseName() + "_" + QString::number(fps.QString::toFloat()*2, 'f', 2) + "FPS." + fo.suffix());
        break;
    case 2:
        ui->lineEdit_Output->setText(fo.absolutePath() + "/" + fi.baseName() + "_" + QString::number(fps.QString::toFloat()*3, 'f', 2) + "FPS." + fo.suffix());
        break;
    case 3:
        ui->lineEdit_Output->setText(fo.absolutePath() + "/" + fi.baseName() + "_" + QString::number(fps.QString::toFloat()*4, 'f', 2) + "FPS." + fo.suffix());
        break;
    }
}
...
void MainWindow::on_lineEdit_Fps_editingFinished() {
    if (ui->lineEdit_Fps->text().toFloat() > fps.toFloat()) {
        ui->lineEdit_Output->setText(fo.absolutePath() + "/" + fi.baseName() + "_" + ui->lineEdit_Fps->text() + "FPS." + fo.suffix());
        ui->comboBox_Fps->setCurrentIndex(0);
    }
}
    ...
    case 0:
        if (type == "dir") {
            ...
            if (numPart == 0) {
                ...
                float dur;
                for (int i = 0; i < numPart; i++) {
                    QFileInfo file = QFileInfo(fi.absolutePath() + '/' + fi.baseName() + "_splited/" + QString::number(i, 10) + '.' + fi.suffix());
